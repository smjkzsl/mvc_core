...
namespace Workman.Util
{
    ...
    public class ExcelHelper
    {
        ...
        public static void ExcelDownload(DataTable dtSource, ExcelConfig excelConfig)
        {
            ...
            //Workman.Util.HttpContext curContext = Workman.Util.HttpContext.Current;
            //// 设置编码和附件格式
        ...
        public static MemoryStream ExportMemoryStream(DataTable dtSource, ExcelConfig excelConfig)
        {
            ...
            #region 右击文件 属性信息
            {
                ...
                si.Author = "张山"; //填加xls文件作者信息
                si.ApplicationName = "红云信息"; //填加xls文件创建程序信息
                si.LastAuthor = "张山"; //填加xls文件最后保存者信息
                si.Comments = "张山"; //填加xls文件作者信息
