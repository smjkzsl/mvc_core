...
namespace Workman.Util
{
    ...
    public static class DirFileHelper
    {
        ...
        {
            directoryPath = HttpContext.Current.MapPath(directoryPath);
            if (IsExistDirectory(directoryPath))
            {
                //删除目录中所有的文件
                string[] fileNames = GetFileNames(directoryPath);
        ...
        public static void CreateFile(string dir, string pagestr)
        {
            ...
            System.IO.StreamWriter sw = new System.IO.StreamWriter(HttpContext.Current.MapPath("/") + "\\" + dir, false, System.Text.Encoding.GetEncoding("utf-8"));
            sw.Write(pagestr);
            sw.Close();
        }
        /// <summary>
        ...
        {
            return HttpContext.Current.MapPath(filePath);
        }
        #endregion
