using Workman.PlugIns.Base.AuthorizeModule;
using Workman.PlugIns.Base.SystemModule;
using Workman.PlugIns.Organization;
using Workman.Cache.Base;
using Workman.Cache.Factory;
using System;
...
namespace Workman.Util.Operat
{
    ...
    public class OperatorHelper
    {
        ...
        private string cacheKeyOperator = "Workman_adms_operator_";// +登录者token
        private string cacheKeyToken = "Workman_adms_token_";// +登录者token
        private string cacheKeyError = "Workman_adms_error_";// + Mark

        private string cacheKeyInfo = "Workman_adms_info_";// + Mark
        /// <summary>
        /// 秘钥
        /// </summary>
        private string LoginUserToken = "Workman_ADMS_V7_Token";
        /// <summary>
        /// 标记登录的浏览器
        /// </summary>
        private string LoginUserMarkKey = "Workman_ADMS_V7_Mark";
        /// <summary>
        /// 获取实例
        /// </summary>
