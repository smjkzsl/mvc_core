...
namespace Workman.Util
{
    ...
    public class WebHelper
    {
        ...
        public static void WriteSession<T>(string key, T value)
        {
            if (key.IsEmpty())
                return;
            HttpContext.Current.Session.SetObjectAsJson(key, value);
        }
        ...
        public static void RemoveCookie(string CookiesName)
        {
            ...
            coption.Expires = DateTimeOffset.Now.AddYears(-5);
            HttpContext.Current.Response.Cookies.Append(CookiesName, "", coption);
        }
        #endregion
        ...
        public static string GetUITheme()
        {
            ...
            try
            {
                string learn_UItheme = WebHelper.GetCookie("Learn_Lib_V6.1_UItheme");
